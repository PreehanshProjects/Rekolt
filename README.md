...
- `index.html`: page and all 46 products (44 produce items plus two fresh pastas), with published prices or “On request”. Includes all 40 items from the owner's 15 September 2026 handwritten inventory; 28 were added, and existing products and rates were retained.
